...
import { stringBooleanSchema } from "../../common-types";
  ...
  responses: {
    "200": z.object({
      LastApplication: z
        ...
        .describe("Date in ISO 8601 format with sub-second precision"),
      Collapsed: z.object({
        ...
        GAME_DISABLED_SKINS_WEAPONS: z
          .string()
          .transform((val) =>
            val.split(",").map((id) => id.substring(1, id.length - 1)),
          ),
        ...
        "settings.livediagnostics.allowedplayers": z
          .string()
          .transform((val) => val.split(","))
          .describe("Comma separated list of PUUIDs"),
