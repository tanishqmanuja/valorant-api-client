...
export const currentGameIDSchema = weakUUIDSchema.describe(
...
export const preferredLevelBorderIDSchema = weakUUIDSchema
  .or(z.literal(""))
  .describe("Preferred Level Border ID");
...
const partyMembershipSchema = z
  .array(z.object({ Subject: playerUUIDSchema }))
  .nullable();
...
export const chatMessagesSchema = z.object({
  messages: z.array(
    z.object({
      ...
      time: z
        .string()
        .transform((s) => new Date(Number(s)))
        .describe("Time in milliseconds since epoch"),
